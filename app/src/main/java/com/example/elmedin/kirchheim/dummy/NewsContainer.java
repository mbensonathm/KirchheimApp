package com.example.elmedin.kirchheim.dummy;
...
public class NewsContainer {
    ...
    private static NewsItem createDummyItem(int position) {
        return new NewsItem(String.valueOf(position), "Story " + position, makeDetails(position));
    }

    private static String makeDetails(int position) {
        StringBuilder builder = new StringBuilder();
        builder.append("Details about this story ").append(position);
